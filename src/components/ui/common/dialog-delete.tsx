...
export default function DialogDelete({ open, onOpenChange, onSubmit, title, isLoading }: { open: boolean; onOpenChange: (open: boolean) => void; onSubmit: () => void; title: string; isLoading: boolean }) {
  return (
