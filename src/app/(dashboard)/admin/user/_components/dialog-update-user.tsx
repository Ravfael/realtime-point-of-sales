import { INITIAL_CREATE_USER_FORM, INITIAL_STATE_CREATE_USER, INITIAL_STATE_UPDATE_USER } from "@/constants/auth-constant";
import { CreateUserForm, createUserSchema, UpdateUserForm, updateUserSchema } from "@/validations/auth-validation";
